<article>
 ...
 <form action="controller/BaseController.php" method="POST">
...
<article>
   ...
   -->
    ...
    include_once '/SardiniaInFood/php/model/Utente.php';
    
    include_once '/SardiniaInFood/php/UtenteFactory.php';

    include_once '/SardiniaInFood/php/model/Azienda.php';
